        ...
        <SwiperSlide>
          <div className='slider-card card_1'>
            ...
            <div className='slider-card-image'>
              ...
              <img className='slider-card-image-person' src='https://demo2.wpopal.com/striz/wp-content/uploads/revslider/slide_home1/slide-home1.png' alt='' />
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className='slider-card card_1'>
            ...
            <div className='slider-card-image'>
              <img className='slider-card-image-image' src='https://demo2.wpopal.com/striz/wp-content/uploads/revslider/slide_home1/slide-home1-2.png' alt='' />
              <img className='slider-card-image-person' src='https://demo2.wpopal.com/striz/wp-content/uploads/revslider/slide_home1/slide-home3.png' alt='' />
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
