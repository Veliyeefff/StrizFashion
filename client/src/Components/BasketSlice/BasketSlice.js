...
const basketSlice = createSlice({
    ...
    reducers: {
        addBasket: (state, actions) => {
            ...
            axios.put(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/users/${user._id}`, updateduser)
        ...
        deleteBasket: (state, actions) => {
            ...
            axios.put(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/users/${user._id}`, newuser)
        },
