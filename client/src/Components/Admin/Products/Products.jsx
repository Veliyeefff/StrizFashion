...
function ProductsList() {
    ...
    const getProducts = async () => {
        let response = await axios.get("https://final-back-o55wmmnpc-veliyeefff.vercel.app/products")
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/products/${id}`)
                    .then(res => {
                        if (res.status === 200) {
