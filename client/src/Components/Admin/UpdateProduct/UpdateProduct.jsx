...
function UpdateProduct() {
    ...
    const getProductById = async () => {
        await axios.get(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/products/${updateId}`)
            .then(res => {
            ...
            <div className="addnewproduct-form">
                <Formik
                    ...
                    onSubmit={(values) => {
                        ...
                        axios.put(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/products/${updateId}`, UpdateProduct)
                            .then(res => {
                                if (res.status === 200) {
                                    message.open({
                                        type: "success",
