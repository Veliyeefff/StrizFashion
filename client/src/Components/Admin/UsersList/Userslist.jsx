...
function Userslist() {
    ...
    const getUsers = async () => {
        let response = await axios.get('https://final-back-o55wmmnpc-veliyeefff.vercel.app/users')
    ...
    const handleDeleteUser = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://final-back-o55wmmnpc-veliyeefff.vercel.app/users/${id}`)
                    .then(res => {
                        if (res.status === 200) {
