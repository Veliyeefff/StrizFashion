...
function LoginSignup() {
    ...
    useEffect(() => {
        axios.get("https://final-back-o55wmmnpc-veliyeefff.vercel.app/users")
            .then(res => {
                setUser(res.data)
            })
    }, [])
            ...
            <div className={`loginsignup-card ${rtClass}`}>
                <div className="login">
                    ...
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            axios.post("https://final-back-o55wmmnpc-veliyeefff.vercel.app/auth/login",
                                {
                                    email: values.email,
                ...
                <div className="signup">
                    ...
                    <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                            axios.post("https://final-back-o55wmmnpc-veliyeefff.vercel.app/auth/register",
                                {
