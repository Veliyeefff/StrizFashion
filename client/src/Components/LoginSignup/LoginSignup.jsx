                ...
                <div className="login">
                    ...
                    >
                        {({ errors }) => (
                            <Form>
                                <label>
                                    <Field className={borderclass} name="email" placeholder="Email..." />
                ...
                <div className="signup">
                    ...
                    >
                        {({ errors }) => (
                            <Form>
                                <label>
                                    <Field className={borderclass3} name="username" placeholder="Username..." />
                                    {errors.username ? setBorderclass3("borderred") : setBorderclass3(null)}

                                </label>
                                <label>
                                    <Field className={borderclass4} type="text" name="email" placeholder='Email...' />
